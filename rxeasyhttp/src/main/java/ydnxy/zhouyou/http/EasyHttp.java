...
import ydnxy.zhouyou.http.cache.RxCache;
import ydnxy.zhouyou.http.cache.converter.IDiskConverter;
import ydnxy.zhouyou.http.cache.converter.SerializableDiskConverter;
import ydnxy.zhouyou.http.cache.model.CacheMode;
import ydnxy.zhouyou.http.cookie.CookieManger;
import ydnxy.zhouyou.http.https.HttpsUtils;
import ydnxy.zhouyou.http.interceptor.HttpLoggingInterceptor;
import ydnxy.zhouyou.http.model.HttpHeaders;
import ydnxy.zhouyou.http.model.HttpParams;
import ydnxy.zhouyou.http.request.CustomRequest;
import ydnxy.zhouyou.http.request.DeleteRequest;
import ydnxy.zhouyou.http.request.DownloadRequest;
import ydnxy.zhouyou.http.request.GetRequest;
import ydnxy.zhouyou.http.request.PostRequest;
import ydnxy.zhouyou.http.request.PutRequest;
import ydnxy.zhouyou.http.utils.HttpLog;
import ydnxy.zhouyou.http.utils.RxUtil;
...
//        headers.put("Authorization", "Bearers" + " " + SharePreferenceUtils.get(getContext(), SharePreferenceParams.USERTOKEN, ""));
//        headers.put("DeviceCode", "ANDROID");
//        headers.put("appVersion", ApiContact.AppVersionName);
//        headers.put("DeviceIdentify", DeviceIdUtil.getDeviceId(getContext()));
//        headers.put("Accept-Language", "tw");
        return new PostRequest(url).headers(headers);
    }
