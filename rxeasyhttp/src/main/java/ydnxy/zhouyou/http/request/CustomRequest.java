...
import ydnxy.zhouyou.http.cache.model.CacheResult;
import ydnxy.zhouyou.http.callback.CallBack;
import ydnxy.zhouyou.http.callback.CallBackProxy;
import ydnxy.zhouyou.http.func.ApiResultFunc;
import ydnxy.zhouyou.http.func.CacheResultFunc;
import ydnxy.zhouyou.http.func.HandleFuc;
import ydnxy.zhouyou.http.func.RetryExceptionFunc;
import ydnxy.zhouyou.http.model.ApiResult;
import ydnxy.zhouyou.http.subsciber.CallBackSubsciber;
import ydnxy.zhouyou.http.transformer.HandleErrTransformer;
