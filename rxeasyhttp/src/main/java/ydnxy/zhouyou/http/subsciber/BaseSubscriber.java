...
package ydnxy.zhouyou.http.subsciber;
...
import static ydnxy.zhouyou.http.utils.Utils.isNetworkAvailable;
...
//                if (!NetUtils.isWifi(contextWeakReference.get())) {
//                EventBus.getDefault().post(new ErrorMsg("The network is unstable"));
//                } else {
//                    EventBus.getDefault().post(new ErrorMsg("当前网络不稳定，请检查代理或VPN是否关闭"));
//                }
